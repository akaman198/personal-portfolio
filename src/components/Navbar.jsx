    ...
    <div className="flex text-2xl justify-between text-gray-200 items-center px-4 max-w-[1040px] mx-auto h-24">
      ...
      <ul className="hidden md:flex gap-12 z-10 cursor-pointer">
        <li className="relative group">
          ...
          <span className="absolute bottom-0 left-0 w-full h-1 bg-sky-600 transform scale-x-0 group-hover:scale-x-100 transtion-transform duration-300 ease-in-out"></span>
        </li>
